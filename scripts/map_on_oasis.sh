...
EXEC_DIR=/projects/glass-group/bioinformatics/glassutils/mapping_scripts
...
Usage: ${curr_file} <1: tophat|bowtie|STAR|send|clean > <2: path to data on TSCC> <3: genome > <4: email address >
